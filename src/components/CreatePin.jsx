...
const CreatePin = ({user}) => {
    ...
    const uploadImage = (e) => {
      ...
      if(type === 'image/png' || type === 'image/jpg' || type === 'image/svg' || type === 'image/gif' || type === 'image/tiff' || type === 'image/jpeg'){
                    ...
                    <div className="flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420">
                        ...
                        {!imageAsset ? (
                            <label>
                                ...
                                <input type="file" name="upload-image" onChange={uploadImage} className="w-0 h-0" accept="image/png, image/tiff, image/jpg, image/gif, image/jpeg"/>
                ...
                <div className="flex flex-1 flex-col gap-6 lg:pl-5 mt-5 w-full">
                    ...
                    <div className="flex flex-col">
                        <div>
                            ...
                            <select onChange={(e) => setCategory(e.target.value)} className="outline-none w-4/5 text-base border-b-2 border-gray-200 p-2 rounded-md curs">
